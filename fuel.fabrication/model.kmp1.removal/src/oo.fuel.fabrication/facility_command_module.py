...
########################################################################
    ...
    def process_batch(self):
        ...
        if  self.failure_check == True: 
            ...
            self.edge.edge_transition(self, batchm, self.melter, self.trimmer)
    ...
    def equipment_failure(self, facility, batchm, heelm):
        ...
        if muf_check3 == True: 
            ...
            if muf_check_2_melter == True:
                ...
                self.edge.edge_transition(self, batchm2, self.melter, self.trimmer)
                ...
                muf_check2 = self.kmp[2].muf_check_from_recycle(self)
                print "alarm: " + str(muf_check2)
                print "total_alarm: " + str(self.false_alarm_count)
