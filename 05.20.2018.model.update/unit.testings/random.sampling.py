# -*- coding: utf-8 -*-
"""
Created on Sat Jun 23 03:06:04 2018
...
""" This file is to have a unit test of random sampling. 
    Number of vessels, which must be inspected to maintain the detection probability of 0.95, 
	can be calculated by using this equation of 'random sampling'. 
"""
N = [50, 100, 150, 200, 250, 300, 350 , 400, 450, 500] # number of vessels  
beta = 0.05 # non-detection probability 

mu = [0.1, 0.5, 1, 3, 5, 8, 10, 13, 15, 18, 20] # average weights of vessels

# This is to provide the standard error for each weight measurement. 
sigma = [] 
for i in range(11):
