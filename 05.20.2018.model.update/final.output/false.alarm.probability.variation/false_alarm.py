...
results1 = plt.bar(1 +bar_width*15, ave_1, bar_width, alpha = opacity, color ='b', yerr = std_1, error_kw = error_config, label='KMP1', capsize = 4)
results2 = plt.bar(1 +bar_width*16, ave_2, bar_width, alpha = opacity, color ='r', yerr = std_2, error_kw = error_config, label='KMP2')
results3 = plt.bar(1 +bar_width*17, ave_3, bar_width, alpha = opacity, color ='orange', yerr = std_3, error_kw = error_config, label='KMP3')
results = plt.bar(1 +bar_width*18, ave_total, bar_width, alpha = opacity, color ='g', yerr = std_total, error_kw = error_config, label='total')
...
results1_2 = plt.bar(1 +bar_width*22, ave_1_2, bar_width, alpha = opacity, color ='b', yerr = std_1_2, error_kw = error_config, capsize = 4)
results2_2 = plt.bar(1 +bar_width*23, ave_2_2, bar_width, alpha = opacity, color ='r', yerr = std_2_2, error_kw = error_config)
results3_2 = plt.bar(1 +bar_width*24, ave_3_2, bar_width, alpha = opacity, color ='orange', yerr = std_3_2, error_kw = error_config)
results_2 = plt.bar(1 +bar_width*25, ave_total_2, bar_width, alpha = opacity, color ='g', yerr = std_total_2, error_kw = error_config)
...
results1_3 = plt.bar(1 +bar_width*29, ave_1_3, bar_width, alpha = opacity, color ='b', yerr = std_1_3, error_kw = error_config, capsize = 4)
results2_3 = plt.bar(1 +bar_width*30, ave_2_3, bar_width, alpha = opacity, color ='r', yerr = std_2_3, error_kw = error_config)
results3_3 = plt.bar(1 +bar_width*31, ave_3_3, bar_width, alpha = opacity, color ='orange', yerr = std_3_3, error_kw = error_config)
results_3 = plt.bar(1 +bar_width*32, ave_total_3, bar_width, alpha = opacity, color ='g', yerr = std_total_3, error_kw = error_config)
...
results1_4 = plt.bar(1 +bar_width*8, ave_1_4, bar_width, alpha = opacity, color ='b', yerr = std_1_4, error_kw = error_config, capsize = 4)
results2_4 = plt.bar(1 +bar_width*9, ave_2_4, bar_width, alpha = opacity, color ='r', yerr = std_2_4, error_kw = error_config)
results3_4 = plt.bar(1 +bar_width*10, ave_3_4, bar_width, alpha = opacity, color ='orange', yerr = std_3_4, error_kw = error_config)
results_4 = plt.bar(1 +bar_width*11, ave_total_4, bar_width, alpha = opacity, color ='g', yerr = std_total_4, error_kw = error_config)

os.chdir('./../')

plt.xlabel('  1.28           1.44           1.645          2.05          2.33\n'  + 'False alarm rate (n)')
