...
results3 = plt.bar(1 +bar_width*3, ave_3, bar_width, alpha = opacity, color ='orange', yerr = std_3, error_kw = error_config, label='KMP3', capsize = 4)
...
results1_1 = plt.bar(1 +bar_width*8, ave_1_1, bar_width, alpha = opacity, color ='b', yerr = std_1_1, error_kw = error_config, capsize = 4)
results2_1 = plt.bar(1 +bar_width*9, ave_2_1, bar_width, alpha = opacity, color ='r', yerr = std_2_1, error_kw = error_config)
results3_1 = plt.bar(1 +bar_width*10, ave_3_1, bar_width, alpha = opacity, color ='orange', yerr = std_3_1, error_kw = error_config)
results_1 = plt.bar(1 +bar_width*11, ave_total_1, bar_width, alpha = opacity, color ='g', yerr = std_total_1, error_kw = error_config)
