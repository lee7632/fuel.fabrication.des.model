...
os.chdir(os.getcwd() + "/1000.test.runs.with.kmp1.measurement.error.percent.0.05")
...
# 0.01
os.chdir("./../1000.test.runs.with.kmp1.measurement.error.percent.0.01")
...
# 0.1
os.chdir("./../1000.test.runs.with.kmp1.measurement.error.percent.0.1")
